...
//	public List<BoardDTO> getBoards(PageRequestDTO pageRequestDTO, Model model, @AuthenticationPrincipal UserDetailsImpl userDetails){
...
//		model.addAttribute("result", mypageService.getList(pageRequestDTO));		
//		log.info("=========================================================");
//	return null;
//	}    
//}
